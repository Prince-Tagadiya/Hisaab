...
export default function TermsPage() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Offset for header (approx 150px)
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 sm:p-12 lg:p-16 max-w-4xl">
              ...
              <div className="space-y-12">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
                      <div className="flex items-center gap-2 mb-2">
                        <User className="text-[#2b8cee]" size={24} />
                    ...
                    <div className="p-4 rounded-xl bg-slate-50 border border-slate-100">
                      <div className="flex items-center gap-2 mb-2">
                        <Receipt className="text-[#2b8cee]" size={24} />
                ...
                <section className="scroll-mt-28" id="privacy">
                  ...
                  <div className="text-slate-600 leading-relaxed text-base space-y-4">
                    <p>
                      Your privacy is important to us. Please review our <Link className="text-[#2b8cee] hover:underline font-bold" href="/privacy">Privacy Policy</Link> to understand how we collect, use, and share information about you.
                    </p>
                    <p>
                ...
                <div className="bg-slate-50 rounded-xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 border border-slate-100 mt-12">
                  <div className="flex items-start gap-3 w-full md:w-auto">
                    <label className="relative flex items-center p-0.5 rounded-full cursor-pointer group">
                      ...
                      <Check className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-white opacity-0 peer-checked:opacity-100 pointer-events-none font-bold" size={14} />
                    </label>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm font-medium">
              <Link className="text-slate-600 hover:text-[#2b8cee] transition-colors" href="/privacy">Privacy Policy</Link>
              <Link className="text-slate-600 hover:text-[#2b8cee] transition-colors" href="#">Contact Support</Link>
            </div>
          </div>
        </div>
      </footer>
