...
async function GET(req) {
    try {
        ...
        const groupDocs = await __TURBOPACK__imported__module__$5b$project$5d2f$hisaab$2d$v2$2f$models$2f$Group$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            _id: {
                $in: groupIds
            }
        });
        // Create a map for quick lookup
        const groupMap = new Map(groupDocs.map((g)=>[
                g._id.toString(),
                g
            ]));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b74b5e49._.js.map