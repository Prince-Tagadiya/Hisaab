...
export default function LandingPage() {
  return (
    <div className="relative flex min-h-screen flex-col overflow-x-hidden bg-[#f6f7f8] text-[#111827] font-['Inter',sans-serif] antialiased selection:bg-[#2b8cee]/20 selection:text-[#2b8cee] transition-colors duration-300">
      {/* Navigation */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Link to="/login" className="hidden sm:flex text-sm font-medium text-[#111827] hover:text-[#2b8cee] transition-colors">
                Log In
              </Link>
              <Link to="/login" className="flex items-center justify-center rounded-lg bg-[#2b8cee] px-4 py-2 text-sm font-bold text-white shadow-sm hover:bg-[#1a6bb5] transition-all active:scale-95">
                Get Started
              </Link>
            </div>
          </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
            ...
            <div className="flex flex-col gap-6 max-w-2xl">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <Link to="/login" className="flex h-12 items-center justify-center rounded-lg bg-[#2b8cee] px-8 text-base font-bold text-white shadow-lg hover:bg-[#1a6bb5] hover:shadow-xl transition-all active:scale-95">
                  Start Tracking Free
                </Link>
        ...
        <section className="w-full px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl overflow-hidden rounded-3xl bg-[#2b8cee] text-white shadow-2xl">
            <div className="flex flex-col items-center gap-8 px-6 py-16 text-center sm:px-12 md:py-20">
              ...
              <Link to="/login" className="flex min-w-[160px] cursor-pointer items-center justify-center rounded-xl bg-white px-8 py-4 text-base font-bold text-[#2b8cee] shadow-lg hover:bg-blue-50 transition-colors active:scale-95">
                Get Started Free
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="mt-4 flex flex-col gap-2">
                <li><Link className="text-sm text-[#6b7280] hover:text-[#2b8cee] transition-colors" to="/privacy">Privacy</Link></li>
                <li><Link className="text-sm text-[#6b7280] hover:text-[#2b8cee] transition-colors" to="/terms">Terms</Link></li>
              </ul>
            </div>
          </div>
