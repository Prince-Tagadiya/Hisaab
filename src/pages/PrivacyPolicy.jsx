      ...
      <header className="sticky top-0 z-50 w-full bg-white/80 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            {/* Action Button */}
            <Link to="/" className="flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-[#2b8cee] hover:bg-[#2b8cee]/90 transition-colors text-white text-sm font-bold shadow-sm ring-offset-2 focus:ring-2 focus:ring-[#2b8cee]/50">
              ...
              <div className="space-y-12">
                ...
                <section className="scroll-mt-28" id="security">
                  <div className="flex items-start gap-4 p-6 bg-[#2b8cee]/5 border border-[#2b8cee]/20 rounded-xl">
                    ...
                    <div>
                      <h2 class="text-xl font-bold text-slate-900 mb-2">4. Data Security</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm font-medium">
              <Link className="text-slate-600 hover:text-[#2b8cee] transition-colors" to="/terms">Terms of Service</Link>
              <Link className="text-slate-600 hover:text-[#2b8cee] transition-colors" to="/cookies">Cookies</Link>
              <Link className="text-slate-600 hover:text-[#2b8cee] transition-colors" to="/support">Support</Link>
            </div>
          </div>
        </div>
      </footer>
